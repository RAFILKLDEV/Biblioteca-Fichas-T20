        ...
        <div className="Npc">
          <div className="About" ref={tabAbout}>
            ...
            <div>
              ...
              Mestres em controlar NPCS com Estatisticas e também para aqueles
              que amam ter seus NPCS Organizados.
            </div>
            <h3>
              Esse é mais um dos meus projetos na minha jornada como
              Desenvolvedor Front-End.
            </h3>
            <div>
              Estou procurando por oportunidades para trabalhar na area, será
              ...
              <ul>
                ...
                <ul>
                  ...
                  <ul>
                    ...
                    <li>
                      Lembre-se é necessário um <b>Bom senso</b> na hora de
                      criar o NPC.
                    </li>
                  </ul>
                </ul>
                <ul>
                  ...
                  <ul>
                    ...
                    <li>
                      Este tipo de NPC pode ser um Aliado ou Inimigo que
                      necessita de <b>Estatisticas</b>.
                    </li>
                  </ul>
                  <ul>
